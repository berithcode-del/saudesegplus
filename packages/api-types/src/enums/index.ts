export type Role =
  "ADMIN" | "OPERATOR" | "DOCTOR" | "PATIENT" | "COMPANY_ADMIN" | "CLINIC";

export type DataEnvironment = "REAL" | "SANDBOX";

export const DataEnvironmentEnum: Record<DataEnvironment, DataEnvironment> = {
  REAL: "REAL",
  SANDBOX: "SANDBOX",
};
...
export const ExamRequestStatusEnum: Record<
  ExamRequestStatus,
  ExamRequestStatus
> = {
