...
exports.SupportModule = SupportModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [support_service_1.SupportService, support_gateway_1.SupportGateway, prisma_service_1.PrismaService, ws_jwt_guard_1.WsJwtGuard],
        exports: [support_service_1.SupportService, support_gateway_1.SupportGateway],
    })
], SupportModule);
