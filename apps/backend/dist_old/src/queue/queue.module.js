...
exports.QueueModule = QueueModule = __decorate([
    (0, common_1.Module)({
        imports: [company_module_1.CompanyModule, auth_module_1.AuthModule, presence_module_1.PresenceModule],
        controllers: [queue_controller_1.QueueController],
        providers: [queue_service_1.QueueService, queue_gateway_1.QueueGateway, prisma_service_1.PrismaService, ws_jwt_guard_1.WsJwtGuard],
