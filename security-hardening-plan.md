...
## Tasks
- [x] Task 1: Inventariar rotas e classificar publico/protegido por papel.
...
- [x] Task 2: Remover `@Public()` de endpoints sensiveis e aplicar RBAC.
...
- [x] Task 3: Proteger rotas do frontend com middleware.
...
- [x] Task 4: Fortalecer JWT, sessao e login.
...
- [x] Task 5: Criar rate limits por rota critica.
...
- [x] Task 6: Padronizar DTOs e limites de entrada.
...
- [x] Task 7: Endurecer upload e arquivos estaticos.
...
- [x] Task 8: Aplicar headers, CORS e WebSocket seguros.
...
- [x] Task 9: Tratar erros, logs e exposicao de dados.
...
- [x] Task 10: Criar suite de seguranca pre-producao.
...
## Done When
- [x] Zero endpoints sensiveis com `@Public()` sem justificativa documentada.
- [x] Todas as rotas de painel exigem login e papel correto no frontend e no backend.
- [x] Uploads tem limite, tipo permitido e autorizacao por dono.
- [x] Login, portal auth e uploads tem rate limit especifico.
- [x] DTOs cobrem tamanho, formato e enum das entradas principais.
- [x] App nao inicia em producao sem secrets obrigatorios.
- [x] Headers e CORS/WebSocket estao restritos a dominios esperados.
- [x] Testes de seguranca passam no pipeline local antes do deploy.
